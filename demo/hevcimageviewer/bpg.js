...
BPG.prototype.readFromHEVC = function (hevcframe, fileSize, dts) {
  ...
  this.header.log2_min_luma_coding_block_size_minus3 =
    hevcframe.SPS.log2_min_luma_coding_block_size_minus3;
  this.header.log2_diff_max_min_luma_coding_block_size =
    hevcframe.SPS.log2_diff_max_min_luma_coding_block_size;
  this.header.log2_min_transform_block_size_minus2 =
    hevcframe.SPS.log2_min_transform_block_size_minus2;
  this.header.log2_diff_max_min_transform_block_size =
    hevcframe.SPS.log2_diff_max_min_transform_block_size;
  this.header.max_transform_hierarchy_depth_intra =
    hevcframe.SPS.max_transform_hierarchy_depth_intra;
  this.header.sample_adaptive_offset_enabled_flag =
    hevcframe.SPS.sample_adaptive_offset_enabled_flag;
  ...
  if (this.header.pcm_enabled_flag) {
    ...
    this.header.pcm_sample_bit_depth_chroma_minus1 =
      hevcframe.SPS.pcm_sample_bit_depth_chroma_minus1;
    this.header.log2_min_pcm_luma_coding_block_size_minus3 =
      hevcframe.SPS.log2_min_pcm_luma_coding_block_size_minus3;
    this.header.log2_diff_max_min_pcm_luma_coding_block_size =
      hevcframe.SPS.log2_diff_max_min_pcm_luma_coding_block_size;
    this.header.pcm_loop_filter_disabled_flag = hevcframe.SPS.pcm_loop_filter_disabled_flag;
  }
  this.header.strong_intra_smoothing_enabled_flag =
    hevcframe.SPS.strong_intra_smoothing_enabled_flag;
  ...
  if (hevcframe.SPS.sps_range_extension_flag) {
    this.header.transform_skip_rotation_enabled_flag =
      hevcframe.SPS.transform_skip_rotation_enabled_flag;
    this.header.transform_skip_context_enabled_flag =
      hevcframe.SPS.transform_skip_context_enabled_flag;
    ...
    this.header.extended_precision_processing_flag =
      hevcframe.SPS.extended_precision_processing_flag;
    this.header.intra_smoothing_disabled_flag = hevcframe.SPS.intra_smoothing_disabled_flag;
    this.header.high_precision_offsets_enabled_flag =
      hevcframe.SPS.high_precision_offsets_enabled_flag;
    this.header.persistent_rice_adaptation_enabled_flag =
      hevcframe.SPS.persistent_rice_adaptation_enabled_flag;
    this.header.cabac_bypass_alignment_enabled_flag =
      hevcframe.SPS.cabac_bypass_alignment_enabled_flag;
  }
