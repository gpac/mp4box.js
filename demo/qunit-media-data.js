var testFiles = [
  {
    ...
    info_: {
      ...
      hasIOD: true,
      brands: ['isom', 'isom'],
      created: new Date('2014-04-10T18:23:58.000Z'),
      modified: new Date('2014-04-10T18:23:58.000Z'),
      tracks: [
        {
          id: 1,
          references: [],
          created: new Date('2012-02-13T23:07:31.000Z'),
          modified: new Date('2014-04-10T18:23:59.000Z'),
          movie_duration: 360000,
          layer: 0,
          alternate_group: 0,
          volume: 0,
          matrix: { 0: 65536, 1: 0, 2: 0, 3: 0, 4: 65536, 5: 0, 6: 0, 7: 0, 8: 1073741824 },
          track_width: 320,
          track_height: 180,
          timescale: 25000,
          duration: 15000000,
