...
The interpretation of these values is:
...
- **rapAlignement**: boolean, indicating if segments should start with a RAP. If not provided, the default is true. Note the spelling
of this property.
...
- **rapAlignement**: boolean, indicating if sample arrays should start with a RAP. If not provided, the default is true. Note the spelling of this property.
