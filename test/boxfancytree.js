import { MPEG4DescriptorParser } from '../dist/mp4box.esm.js';
export function getFancyTreeDataFromDescChildren(descs) {
  var array = [];
...
export function getFancyTreeDataFromDesc(desc) {
  var array = [];
  var fancytree_node = {};
  array.push(fancytree_node);
...
export function getFancyTreeDataFromBoxes(boxes) {
  var array = [];
