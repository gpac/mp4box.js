...
import { generateBoxTable } from './boxHtmlTable.js';

export function createLoadBar(parent, label, id, fileobj, finalizeUI) {
  var loadbar = $('<div></div>');
...
export function createFancyTree(parent, fileobj) {
