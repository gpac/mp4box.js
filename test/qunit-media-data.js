var testFiles = [
	{ // 0
		...
		url: 'http://download.tsi.telecom-paristech.fr/gpac/mp4box.js/mp4/h264bl.mp4',
	...
	{ // 1
		...
		url: 'http://download.tsi.telecom-paristech.fr/gpac/mp4box.js/mp4/a.mp4'
	},
	{ // 2
		desc: "non-fragmented MP4 file with MPEG-4 AAC stream",
		url: 'http://download.tsi.telecom-paristech.fr/gpac/mp4box.js/mp4/aaclow.mp4'
	},
	{ // 3
		desc: "non-fragmented MP4 file with two AVC video streams",
		url: 'http://download.tsi.telecom-paristech.fr/gpac/mp4box.js/mp4/2v.mp4'
	},
	{ // 4
		desc: "non-fragmented MP4 file with AVC, AAC and WebVTT",
		url: 'http://download.tsi.telecom-paristech.fr/gpac/mp4box.js/mp4/avw.mp4'
	},
	{ // 5
		desc: "non-fragmented MP4 file with 1 WebVTT stream",
		url: 'http://download.tsi.telecom-paristech.fr/gpac/mp4box.js/mp4/subtitle-srt-wvtt.mp4'
	},
	{ // 6
		desc: "non-fragmented MP4 file with 1 text:tx3g stream",
		url: 'http://download.tsi.telecom-paristech.fr/gpac/mp4box.js/mp4/subtitle-srt-tx3g.mp4'
	},
	{ // 7
		desc: "non-fragmented MP4 file with 1 text:stse stream",
		url: 'http://download.tsi.telecom-paristech.fr/gpac/mp4box.js/mp4/anim-svg.mp4'
	},
	{ // 8
		desc: "non-fragmented MP4 file with 1 subt:stpp stream",
		url: 'http://download.tsi.telecom-paristech.fr/gpac/mp4box.js/mp4/subtitle-ttml-stpp.mp4'
	},
	{ // 9
		desc: "non-fragmented MP4 file with single AVC stream, moov is last box",
		url: 'http://download.tsi.telecom-paristech.fr/gpac/mp4box.js/mp4/moov_last.mp4'
	},
	{ // 10
		desc: "long movie",
		url: 'http://download.tsi.telecom-paristech.fr/gpac/mp4box.js/mp4/Bad.Influence.se4ep13.mp4'
	},
	{ // 11
		desc: "Incomplete file from torrent",
		url: 'http://download.tsi.telecom-paristech.fr/gpac/mp4box.js/mp4/as2-incomplete.mp4'
	}
];