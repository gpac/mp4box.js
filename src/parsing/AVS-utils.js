...
function HexadecimalValue(value, descriptionFn) {
    this.value = value;
    this.description = (typeof descriptionFn == "function") ? descriptionFn(value) : null;
}
...
BinaryValue.prototype.get = function() {
    return this.value;
}

function DescribedValue(value, descriptionFn) {
    this.value = value;
    this.description = (typeof descriptionFn == "function") ? descriptionFn(value) : null;
}
...
phBitBuffer.prototype.load = function(data) {
    this._buffer = data;
...
phBitBuffer.prototype.appendUint8 = function(byte) {
...
phBitBuffer.prototype.bitsRemaining = function() {return currentWriteBitOffset() - currentReadBitOffset();};
