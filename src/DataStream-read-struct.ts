...
export default {
  readStruct: function (this: DataStream, structDefinition: string) {
    let struct: any = {};
    let t;
    let v;
 ...
 */
  readUCS2String: function (this: DataStream, length?: number, endianness?: boolean) {
    return String.fromCharCode.apply(null, Array.from(this.readUint16Array(length, endianness)));
  },
 ...
 */
  readType: function (this: DataStream, t: any, struct: any): any {
