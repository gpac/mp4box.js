...
BoxParser.a3asSampleEntry.prototype.getCodec = */
BoxParser.av3aSampleEntry.prototype.getCodec = function() {
	var baseCodec = BoxParser.SampleEntry.prototype.getCodec.call(this);
	var codec_id_str = this.dca3.audio_codec_id ? ("" +this.dca3.audio_codec_id.get()).padStart(2, '0') : 'XX';
	return baseCodec + '.' + codec_id_str;
}
